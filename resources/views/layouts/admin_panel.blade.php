...
<div class="app-body">
    <div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="/admin/panel"><i class="icon-speedometer"></i> میزکار <span class="badge badge-primary">جدید</span></a>
                </li>
                <li class="nav-item nav-dropdown">
                    <a class="nav-link " href="/admin/panel/checkout"><i class="icon-puzzle"></i>تسویه حساب ها</a>
                </li>
                <li class="nav-item nav-dropdown">
                ...
                <li class="nav-item nav-dropdown">
                    <a class="nav-link " href="/admin/panel/ticket"><i class="icon-puzzle"></i>پشتیبانی</a>
                </li>
                <li class="nav-item nav-dropdown">
                    <a class="nav-link " href="/admin/panel/gallery"><i class="icon-puzzle"></i>مدیریت رسانه</a>
                </li>
            </ul>
        </nav>
    </div>
